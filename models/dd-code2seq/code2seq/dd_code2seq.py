...
if __name__ == '__main__':
    ...
    # file to store successfully processed file list
    done_file_writer = open(hp.g_test_file_done, "w")
    done_file_writer.write("path\n")
    ...
    for idx, java_file in enumerate(file_list):
        ...
        try:
            ...
            print("\nDone [{}]: {}\n".format(idx + 1, java_file))
            done_file_writer.write("{}\n".format(java_file))
        except Exception as e:
            print("\nError [{}]: {}".format(idx + 1, java_file))
            print("Exception:{}\n".format(str(e)))
