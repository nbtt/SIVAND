...
g_c2s_model = "/Users/lap13494/workspace/ppl-extra-final/models/java-large-model/model_iter52.release"
...
g_test_file = "/Users/lap13494/workspace/ppl-extra-final/SIVAND/data/selected_input/mn_c2s/c2s_js_test.txt"
g_test_file_done = g_test_file + ".done"
...
JAR_LOAD_JAVA_METHOD = "/Users/lap13494/workspace/ppl-extra-final/SIVAND/others/LoadJavaMethod/target/jar/LoadJavaMethod.jar"
JAR_C2S_JAVA_EXTRACTOR = "/Users/lap13494/workspace/ppl-extra-final/SIVAND/models/dd-code2seq/code2seq/JavaExtractor/JPredict/target/JavaExtractor-0.0.1-SNAPSHOT.jar"
...
def prediction_with_c2s(model, root_path, java_file):
    try:
        ...
        print("root_path = {}, java_file = {}, g_db_name = {}".format(root_path, java_file, g_db_name))
